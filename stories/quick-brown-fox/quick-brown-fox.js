(function (root, story) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.quickBrownFox = story;
  }
})(this, {
  title: "The Quick Brown Fox",
  description: "The moving story of a quick brown fox (lots of text to test the clients)",
  messages: [
  ...
  input: function(command) {
    if(command == "quit") {
      ...
      if(this.index >= this.messages.length) {
        this.isFinished = true;
        this.latestMessage = "THE END";
      } else {
        this.latestMessage = this.messages[this.index];
      }
    }
  }
});